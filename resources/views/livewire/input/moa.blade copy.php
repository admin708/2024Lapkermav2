<div>
    ...
    @else
        @if ($cek_dasar_dokumen_kerjasama)
            <div class="modal fade show" id="backDropModal" data-bs-backdrop="static" tabindex="-1"
                style="display: block; padding-left: 0px; background-color: rgba(128, 128, 128, 0.418)" aria-modal="true"
                role="dialog">
                <div class="modal-dialog">{{ $jenis_dokumen_kerjasama }}
                    <form class="modal-content" style="margin-top: 20%">
                        <div class="modal-header">
                            <h5 class="modal-title" id="backDropModalTitle">Buat Dokumen</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                wire:click="redirek"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col mb-3">
                                    <div class="form-check mt-3">
                                        <input wire:model="changeJenis" class="form-check-input" type="radio"
                                            value="2">
                                        <label class="form-check-label" for="defaultRadio1"> Memorandum of Aggreement
                                            (MoA) </label>
                                    </div>
                                    <div class="form-check mt-3">
                                        <input wire:model="changeJenis" class="form-check-input" type="radio"
                                            value="3">
                                        <label class="form-check-label" for="defaultRadio1"> Implementation Arrangement
                                            (IA) </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            <button wire:click="setJenis" wire:loading.attr="disabled" type="button"
    ...
    <div class="row">
        <div class="col-12">
            @if (auth()->user()->role_id == 4 || auth()->user()->role_id == 1)
                <button class="btn btn-primary my-3 form-control"
            ...
            @else
                <button class="btn btn-primary my-3 form-control"
                    ...
                    <span wire:loading wire:target="{{ $jenis_dokumen_kerjasama == 2 ? 'saveMoA' : 'saveIa' }}"
                        class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                    <span wire:loading.remove wire:target="{{ $jenis_dokumen_kerjasama == 2 ? 'saveMoA' : 'saveIa' }}">
                        Simpan
                    </span>
                </button>
            @endif
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    ...
                    <div class="{{ $jenisKerjasamaField == 2 ? 'd-none' : '' }}">
                        ...
                        <select wire:model="tingkat"
                            class="form-select form-select-sm @error('tingkat') is-invalid @enderror">
                            <option></option>
                            ...
                            @foreach ($findDokumen as $item)
                                ...
                                <div class="offcanvas offcanvas-start" style="width: 50%" tabindex="-1"
                                    ...
                                    <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                                        <p><iframe src="{{ asset('storage/DokumenMoA/' . $item->url) }}"
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    <div class="col-auto mb-3">
                        <label class="mr-sm-2" for="">Pilih Jenis Dokumen Kerjasama
                            {{ auth()->user()->role }}<i class="small text-danger">*</i>
                            <select wire:model="jenis_dokumen_kerjasama"
                                class="form-select form-select-sm mr-sm-2 @error('jenis_dokumen_kerjasama') is-invalid @enderror">
                                <option></option>
                    ...
                    @if ($jenis_dokumen_kerjasama)
                        <div>
                            <label class="form-label" for="select2-dasar-dokumen">
                                Dasar Dokumen Kerjasama <i class="small text-danger">*</i>
                            </label>
                            <div>
                    ...
                    <div>
                        ...
                        <input wire:model.lazy="anggaran" id="anggaranz" type="text"
                            class="form-control form-control-sm">
                    </div>
                    <script>
                        var tanpa_rupiah = document.getElementById('anggaranz');
    ...
    <div class="row">
                    ...
                    <div class="card mb-4">
                        <h5 class="card-header text-primary"><i class="bx bx-link me-3"></i>Pihak {{ $value + 1 }}
                            @if ($key != 0 && end($inputs) == $key)
                                <button type="button" wire:click="takeArray({{ $key + 1 }})"
                        ...
                        <div class="card-body mt-0">
                            <div class="col-auto my-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-lg-7 my-2 {{ optional($status)[$value] == 1 ? 'd-block' : (optional($status)[$value] == 4 ? 'd-block' : '') }}"
                                        ...
                                        <a href="https://www.topuniversities.com/subject-rankings/2022" target="blank"
                            ...
                            @if (optional($nama_pihak)[$key] == 'Universitas Hasanuddin')
                                ...
                                <select wire:model.debounce.500ms="fakultas_pihak.{{ $value }}"
                                        ...
                                        <div class="row col-12">
                                            @php
                                                ...
                                                if (auth()->user()->role_id == 1) {
                                                    $prodiMitras = \App\Models\Prodi::whereIn(
                                                        'id_fakultas',
                                                        $fakultas_pihak,
                                                    )->get();
                                                } else {
                                            ...
                                            <div class="btn-group col-12">
                                                <div class="input-group input-group-sm" data-bs-display="static"
                                                    aria-haspopup="true" aria-expanded="true">
                                                    <input placeholder="Ketik Untuk Mencari "
                                                        wire:model.debounce.500ms="searchProdiMitra.{{ $value }}"
                                                        type="text"
                                                        class="form-control form-control-sm @error('prodiPihak.' . $value) is-invalid @enderror">
                                                    @error('prodiPihak.{{ $value }}')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start {{ optional($searchProdiMitra)[$value] ? 'show' : '' }}"
                                                    data-bs-popper="static">
                                                    @foreach ($prodiMitras as $item)
                                                        <li><button
                                                                wire:click="pushProdiMitra({{ $key }},{{ $item->id }},'{{ $item->nama_resmi }}')"
                                                                class="small dropdown-item"
                                                                type="button">{{ strtoupper($item->nama_resmi) }}</button>
                                                        </li>
                                                    @endforeach
                            ...
                            @else
                                    ...
                                    ">
                                        ...
                                        <div class="btn-group col-12">
                                            <div class="input-group input-group-sm" data-bs-display="static"
                                                aria-haspopup="true" aria-expanded="true">
                                                <input placeholder="Ketik Untuk Mencari "
                                                    {{ optional($lockFakultas)[$value] == 1 ? 'disabled' : '' }}
                                                    wire:model.debounce.500ms="nama_fakultas.{{ $key }}"
                                                    type="text"
                                                    class="form-control form-control-sm @error('fakultas_pihak.' . $value) is-invalid @enderror">
                                                <span wire:click="clearLockFakultas({{ $key }})"
                                                    class="input-group-text cursor-pointer {{ optional($lockFakultas)[$value] == 1 ? 'd-block' : 'd-none' }} "><i
                                                        class="bx bx-x"></i></span>
                                                <span onclick="addFakultasMitra()"
                                                    class="input-group-text cursor-pointer {{ optional($lockFakultas)[$value] == 1 ? 'd-none' : 'd-block' }}"><i
                                                        class="bx bx-plus"></i></span>
                                            ...
                                            @enderror
                                            @php
                                                $fakultas22 = \App\Models\FakultasPihak::where(
                                                    'nama_fakultas',
                                                    'LIKE',
                                                    '%' . optional($nama_fakultas)[$value] . '%',
                                                )->paginate(10);
                                            @endphp
                                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start {{ optional($nama_fakultas)[$value] ? (optional($lockFakultas)[$value] ? '' : 'show') : '' }}"
                                                data-bs-popper="static">
                                                @forelse($fakultas22 as $item)
                                                    <li><button
                                                            wire:click="pushNamaFakultas({{ $key }},{{ $item->id }},'{{ $item->nama_fakultas }}')"
                                                            class="small dropdown-item"
                                                            type="button">{{ strtoupper($item->nama_fakultas) }}</button>
                                                    </li>
                                                @empty
                                ...
                                <div class="col-auto my-2">
                                    ...
                                    ">
                                        ...
                                        <div class="row col-12">
                                            @php
                                                $prodiMitras = \App\Models\ProdiMitra::where(
                                                    'nama_resmi',
                                                    'LIKE',
                                                    '%' . optional($searchProdiMitra)[$value] . '%',
                                                )->paginate(10);
                                            @endphp
                                            <div class="btn-group col-12">
                                                <div class="input-group input-group-sm" data-bs-display="static"
                                                ...
                                                @if (isset($prodiPihak[$key]))
                                                    @foreach ($getProdiMitras->whereIn('id', $prodiPihak[$key]) as $item)
                                                        <div class="input-group input-group-sm my-1"
                                                            ...
                                                            <span role="button"
                                                                wire:click="unsetFakultas({{ $key }},{{ $item->id }})"
                                                                class=" small input-group-text">X</span>
        ...
        <div class="col-sm-12 col-lg-5">
            <div class="card mb-4">
                <h5 class="card-header text-primary"><i class="bx bx-unite me-3"></i>Bentuk Kegiatan</i>
                ...
                <div class="card-body">
                    <div class="col-auto my-2">
                        <div class="col-sm-12">
                            <label class="@error('sdgs') text-danger @enderror">SDGS <i
                                    class="small text-danger">*</i></label>
                        </div>
                        <div class="col-sm-12">
                            <select class="form-select form-select-sm @error('sdgs') is-invalid @enderror"
                                ...
                                @foreach ($getSdgs as $itemz)
                                    ...
                                    <option value="{{ $itemz->id }}">{{ $itemz->id }} | {{ $itemz->nama }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    @if ($arraySdgs)
                        @foreach ($arraySdgs as $key => $item)
                            <p><i class="bx bx-x btn btn-sm btn-secondary"
                                    wire:click="minArraySdgs('{{ $key }}')" role="button"></i>
                                {{ $item }} | {{ $getSdgs->find($item)->nama }}</p>
                        @endforeach
                    @endif
                    <div class="col-auto my-2">
                        <div class="col-sm-12">
                            <label class="@error('arrayBentukKegiatan') text-danger @enderror">Bentuk Kegiatan
                                Kerjasama <i class="small text-danger">*</i></label>
                        </div>
                    ...
                    @forelse ($arrayBentukKegiatan as $key => $item)
                        <div class="card my-1">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-auto">
                                    <div class="col-sm-12">
                                        <label class="@error('arraySasaran.' . $key) text-danger @enderror"s>Sasaran
                                            <i class="small text-danger">*</i></label>
                                ...
                                <div class="col-auto">
                                    <div class="col-sm-12">
                                        <label class="@error('arrayKinerja.' . $key) text-danger @enderror">Indikator
                                            Kinerja <i class="small text-danger">*</i></label>
                                    </div>
                                    <div class="col-sm-12">
    ...
    @push('custom-scripts')
        ...
        <script>
            ...
            function initializeSelect2(selector, livewireProperty) {
                $(selector).select2();
                $(selector).on('change', function() {
                    let data = $(selector).select2('val');
                    @this.set(livewireProperty, data);
                });
            }

            $(document).ready(function() {
                initializeSelect2('#select2-dasar-dokumen', 'dasar_dokumen_kerjasama');
            });
            ...
            function initializeSearchInstansiDropdown(selector) {
                if ($(selector).length > 0) {
                    // Reinitialize any needed JavaScript-based dropdown or plugin functionality
                    $(selector).on('input', function() {
                        // Optionally handle custom behavior for the input
                    });
                }
            }
            ...
            $(document).ready(function() {
                initializeSearchInstansiDropdown('[wire\\:model]');
            });

            // Reinitialize when Livewire updates the content
