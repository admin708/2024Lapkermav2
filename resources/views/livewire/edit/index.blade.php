                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            @if ($cekDokumen > 1)
                                @if ($yakinHapus == $item->id)
                                    <i role="button" wire:click="hapusDokumen('{{$item->id}}')" class="bx bx-trash text-danger mt-2" style="float: right; font-size: 15px"> yakin hapus ?</i>
                                @else
                                    <i role="button" wire:click="yakinHapusDokumen('{{$item->id}}')" class="bx bx-trash text-danger mt-2" style="float: right"></i>
                                @endif
                            @endif
                        </li>
                                    ...
                                    <div class="row col-12">
                                        @php
                                            if (auth()->user()->role_id == 1) {
                                                $prodiMitras = \App\Models\Prodi::where('id_fakultas', $fakultas_pihak[$value])->get();
                                            } else {
                                        ...
                                        <div class="btn-group col-12">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start {{ optional($searchProdiMitra)[$value] ? 'show':'' }}" data-bs-popper="static">
                                                        ...
                                                        <li><button wire:click="pushProdiMitra({{ $key }},{{ $item->id }},'{{ $item->nama_resmi }}')" class="small dropdown-item
                                                            {{ $item->id == auth()->user()->prodi_id ? 'd-none':($item->id == $prodiEx ? 'd-none':'') }}" type="button">{{ strtoupper($item->nama_resmi) }}</button></li>
                                                        @endforeach
...
<div class="col-sm-12 col-lg-5">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="col-auto my-2">
                <div class="col-sm-12">
                    <label>SDGS <i class="small text-danger">*</i> @error('arraySdgs') <i class="small text-danger">{{$message}}</i> @enderror</label>
                </div>
                <div class="col-sm-12">
